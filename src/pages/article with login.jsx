// src/pages/article with login.jsx
...
export const ArticleWithLogin = () => {
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col">
      {/* TOP NAV (similar to Article, but for logged-in state) */}
      ...
      <main className="flex-1">
        ...
        <section className="w-[90%] mx-auto pb-12 md:pb-16">
          <div className="text-[18px] md:text-[20px] leading-[1.8] text-black font-small text-justify">
            <p className="mb-6">
              At ThaparKart, we believe that one student’s unused item can be
              another’s perfect find. By promoting buying and selling within
              campus, we reduce unnecessary waste and encourage a circular
              economy.
            </p>

            <p className="mb-6">
              From cycle resales to book exchanges, every transaction on
              ThaparKart saves resources that would otherwise go unused. It’s
              not just about saving money — it’s about being mindful of what we
              own and how we share it.
            </p>

            <p className="mb-6">
              Every product listed tells a story — a laptop that found a new
              home, a set of notes passed on to help someone score better, or a
              hostel chair reused instead of being discarded. Each small action
              contributes to a greener Thapar campus.
            </p>

            <p>
              As a student-run initiative, ThaparKart aims to empower students
              to make sustainable choices effortlessly while keeping convenience
        ...
        <section className="w-[90%] mx-auto pb-12 md:pb-16">
          <div className="text-[18px] md:text-[20px] leading-[1.8] text-black font-small text-justify">
            <p className="mb-6">
              ThaparKart is more than just a campus marketplace — it’s a
              community built by students, for students. Whether you’re looking
              for affordable textbooks, a cycle to commute, or decor for your
              hostel room.
            </p>

            <p>
              ThaparKart connects buyers and sellers across the Thapar campus
              safely and easily. Every listing you browse or post contributes to
              a more sustainable and connected student community.
            </p>
          </div>
        </section>
...
export default ArticleWithLogin;
